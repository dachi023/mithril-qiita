...
mq.request = function(method, path, params) {
  ...
  if (method === 'GET') {
    ...
    if (mq.token() == null) {
      throw new Error('mq.token() is must not blank');
    }
    req.data = req;
  }
