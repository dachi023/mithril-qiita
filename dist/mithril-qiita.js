...
mq.request = function(method, path, params) {
  ...
  req = {
    ...
    background: mq.background() != null ? mq.background() : false,
    initialValue: mq.initialValue() != null ? mq.initialValue() : void 0
  };
  if (method === 'GET') {
    req.url += "?" + (((function() {
      var results;
