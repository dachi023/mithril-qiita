...
mq = require('./models/mithril-qiita');

mq.endpoint('https://qiita.com');

module.exports = mq;


},{"./models/mithril-qiita":3}],3:[function(require,module,exports){
var m, mq;
...
mq = {
  ...
  initialValue: m.prop(void 0)
};

mq.request = function(method, path, params) {
  var k, req, v;
  if (params == null) {
    params = {};
  }
  ...
  req = {
    config: function(xhr) {
      return xhr.setRequestHeader('Authorization', "Bearer " + (mq.token()));
    },
    method: method,
  ...
  if (method === 'GET') {
    ...
    if (mq.token() == null) {
      throw new Error('mq.token() is null');
    }
    req.data = req;
  }
...
mq.get = function(path, params) {
  return mq.request('GET', path, params);
};

mq.post = function(path, params) {
  return mq.request('POST', path, params);
};

mq.patch = function(path, params) {
  return mq.request('PATCH', path, params);
};

mq.put = function(path) {
  return mq.request('PUT', path, null);
};

mq["delete"] = function(path) {
  return mq.request('DELETE', path, null);
};

mq.users = function(id) {
  var base, followees, followers, following, followingTags, func, items, path, stocks;
  if (id == null) {
    id = null;
  }
  base = "/api/v2/users";
  ...
  if (id != null) {
    ...
    func.followers = {
      list: function(params) {
        return mq.get(followers, params);
      }
    };
    func.following = {
      list: function(params) {
        return mq.get(followees, params);
      },
      get: function(params) {
        return mq.get(following, params);
      },
      add: function() {
        return mq.put(following);
      },
      "delete": function() {
        return mq["delete"](following);
      }
    };
    func.followingTags = {
      list: function(params) {
        return mq.get(followingTags);
      }
    };
    func.items = {
      list: function(params) {
...
mq.items = function(id) {
  var base, comments, func, like, stock, stockers, taggings;
  if (id == null) {
    id = null;
  }
  if (id == null) {
  ...
  func = {
    ...
    update: function(params) {
      return mq.patch(base, params);
    },
    "delete": function() {
      return mq["delete"](base);
    }
  };
  func.comments = {
    list: function(params) {
      return mq.get(comments, params);
    },
    add: function(params) {
      return mq.post(comments, params);
    }
  };
  func.taggings = {
    add: function(params) {
      return mq.post(taggings, params);
    },
    "delete": function(id) {
      if (id == null) {
        id = null;
      ...
      if (id != null) {
        return mq["delete"](taggings + "/" + id);
      } else {
        throw new Error('tag-id is null');
      }
    }
  };
  func.stockers = {
    list: function(params) {
      return mq.get(stockers, params);
    }
  };
  func.like = {
    add: function() {
    ...
    "delete": function() {
      return mq["delete"](like);
    }
  };
  func.stock = {
    get: function(params) {
      return mq.get(stock, params);
    },
    add: function() {
      return mq.put(stock);
    },
    "delete": function() {
      return mq["delete"](stock);
    }
  };
  return func;
};
